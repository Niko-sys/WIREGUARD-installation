...
function installQuestions() {
	...
	echo "Please answer a few questions before starting the setup."
	...
	echo ""
	echo "Okay, your WireGuard server setup is about to start..."
	echo "You will be able to generate a client config file upon installation."
...
AllowedIPs = ${CLIENT_WG_IPV4}/32,${CLIENT_WG_IPV6}/128" >>"/etc/wireguard/${SERVER_WG_NIC}.conf"
	...
	echo -e "\nHere is your client config file as a QR Code for your smartphones:"
